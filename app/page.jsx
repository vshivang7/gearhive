  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {particles.map((p, i) => (
        <div
          key={i}
          className="absolute w-1 h-2 bg-cyan-400 rounded-full animate-pulse"
          style={{
            left: p.left,
            top: p.top,
...
const AIThinkingAnimation = ({ show }) => {
  if (!show) return null;
  return (
    <div className="flex items-center gap-2 text-cyan-400 mt-4 justify-center">
...
const Button = ({ children, variant = "default", size = "default", className = "", onClick, ...props }) => {
  ...
  const variants = {
    default: "bg-gradient-to-r from-cyan-500 to-purple-500 text-white hover:scale-105 shadow-lg hover:shadow-cyan-400/25",
    ghost: "bg-transparent text-cyan-400 hover:text-cyan-300 hover:bg-white/10",
    outline: "bg-white/10 backdrop-blur-lg border border-white/20 text-white hover:bg-white/20"
  };
  const sizes = {
    default: "px-4 py-2",
...
const AccordionTrigger = ({ children, className = "", isOpen, setIsOpen }) => {
  return (
    <button
      className={`${className} w-full text-left py-4 flex items-center justify-between`}
  ...
  return (
    <div className="flex flex-col pt-20 min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden relative">
      ...
      <div className="fixed top-50 right-10 animate-bounce z-10">
        <Cpu className="w-10 h-10 text-cyan-400 opacity-60"/>
      </div>
      <div className="fixed bottom-20 left-10 animate-bounce z-10" style={{ animationDelay: '1s' }}>
        <Bot className="w-10 h-10 text-purple-400 opacity-60" />
      </div>
      ...
      <section className="relative py-16 md:py-32 min-h-screen flex items-center">
        <div className="max-w-4xl mx-auto text-center relative z-10 px-4">
          <div className="mb-12">
            ...
            <h1 className="text-5xl md:text-8xl mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent animate-pulse font-bold">
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-slate-400">Daily Analysis</div>
              </div>
            </div>

            {/* Enhanced Search Component with Glassmorphism */}
            <div className="max-w-2xl mx-auto mb-8">
              <div className="bg-grey/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="group">
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-lg border border-slate-700/50 rounded-2xl p-6 hover:scale-105 transform transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-400/20">
                  <div className="bg-gradient-to-r from-cyan-500 to-purple-500 w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:rotate-12 transition-transform">
...
<section className="py-16 overflow-hidden">
  <div className="container mx-auto px-4">
    <div className="flex justify-between items-center mb-8">
      <h2 className="text-3xl font-bold text-white">Browse by Make</h2>
...
<div className=" backdrop-blur-lg rounded-2xl p-4 text-center hover:scale-120 transform transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/20">
                ...
                <h3 className="font-medium text-white">{make.name}</h3>
              </div>
            </Link>
          </div>
        ))}
     ...
     {/* Why Choose Us */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transform transition-all duration-300">
                <Car className="h-10 w-10 text-white" />
              </div>
              <h3 className="text-xl font-bold mb-2 text-white">AI-Curated Selection</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Instant AI Scheduling</h3>
              <p className="text-slate-400">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Neural Security</h3>
              <p className="text-slate-400">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold text-white">Browse by Body Type</h2>
            <Button variant="ghost" className="flex items-center" asChild>
        <Link href="/cars"> View All<ChevronRight className="ml-1 h-4 w-4" />
        </Link>
      </Button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((type) => (
              <div key={type.name} className="relative group cursor-pointer">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent rounded-lg flex items-end hover:from-cyan-900/70 transition-all duration-300">
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="w-full space-y-4">
              {faqItems.map((faq, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-lg border border-slate-700/50 rounded-2xl px-6">
                  <AccordionTrigger className="text-white hover:text-cyan-400 flex items-center gap-4">
                    <div className="bg-gradient-to-r from-cyan-500 to-purple-500 w-8 h-8 rounded-full flex items-center justify-center shrink-0">
                      <Bot className="w-4 h-4 text-white" />
                    </div>
                    <span className="flex-1">{faq.question}</span>
                  </AccordionTrigger>
                  <AccordionContent className="text-slate-400 ml-12">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
      ...
      {/* Futuristic Footer */}
<footer className="bg-gradient-to-br from-slate-950 to-slate-900 text-white py-12 mt-16 border-t border-white/10 relative overflow-hidden">
  {/* Neon Glow Bar */}
  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-3/4 h-1 bg-gradient-to-r from-cyan-500 via-purple-500 to-cyan-500 blur-md animate-pulse" />
  ...
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 relative z-10">
    ...
    <div>
      ...
      <ul className="space-y-2 text-slate-400 text-sm">
        ...
        <li><Link href="/cars" className="hover:text-cyan-400 transition">All Cars</Link></li>
        <li><Link href="/reservations" className="hover:text-cyan-400 transition">Reservations</Link></li>
        <li><Link href="/admin" className="hover:text-cyan-400 transition">Admin Portal</Link></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <div className="flex space-x-4 mb-4">
        <a href="#" className="text-cyan-400 hover:scale-110 transition"><Cpu className="w-6 h-6" /></a>
        <a href="#" className="text-purple-400 hover:scale-110 transition"><Bot className="w-6 h-6" /></a>
        <a href="#" className="text-cyan-400 hover:scale-110 transition"><Brain className="w-6 h-6" /></a>
        <a href="#" className="text-purple-400 hover:scale-110 transition"><Zap className="w-6 h-6" /></a>
      </div>
      <p className="text-sm text-slate-400">hello@gearhive.ai</p>
    </div>
  </div>

  <div className="text-center text-sm text-slate-500 mt-10 z-10 relative">
